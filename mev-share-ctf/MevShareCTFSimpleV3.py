...
for event in event_stream(sse_url):
    ...
    if data['txs']:
        if Web3.to_checksum_address(data['txs'][0]['to']) == Web3.to_checksum_address("0x1cdDB0BA9265bb3098982238637C2872b7D12474"):
            ...
            data_to_be_sent['params'][0]['body'].append({
                "tx": Account.sign_transaction({
                    ...
                    "to": Web3.to_checksum_address("0x1cdDB0BA9265bb3098982238637C2872b7D12474"), 
                    "value": "0x0", 
                    "chainId": 5,
                    }, 
                    private_key
