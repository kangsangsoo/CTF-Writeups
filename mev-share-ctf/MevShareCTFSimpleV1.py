...
for event in event_stream(sse_url):
    ...
    if data['logs']:
        if Web3.to_checksum_address(data['logs'][0]['address']) == Web3.to_checksum_address("0x98997b55bb271e254bec8b85763480719dab0e53"):
            ...
            data_to_be_sent['params'][0]['body'].append({
                "tx": Account.sign_transaction({
                    ...
                    "to": Web3.to_checksum_address("0x98997b55bb271e254bec8b85763480719dab0e53"), 
                    "value": "0x0", 
                    "chainId": 5,
                    }, 
                    private_key
