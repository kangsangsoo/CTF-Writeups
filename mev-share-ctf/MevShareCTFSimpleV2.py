...
for event in event_stream(sse_url):
    ...
    if data['txs']:
        if Web3.to_checksum_address(data['txs'][0]['to']) == Web3.to_checksum_address("0x65459dD36b03Af9635c06BAD1930DB660b968278"):
            ...
            data_to_be_sent['params'][0]['body'].append({
                "tx": Account.sign_transaction({
                    ...
                    "to": Web3.to_checksum_address("0x65459dD36b03Af9635c06BAD1930DB660b968278"), 
                    "value": "0x0", 
                    "chainId": 5,
                    }, 
                    private_key
